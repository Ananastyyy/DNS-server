...
class Cacher:
    ...
    # Добавление записей в буффер с кэшем
    def add(
            self,
            q_name: str,
            q_type: QueryType,
    ...
    # Получение записей из буффера с кэшем
    ...
    # Проверка записей на истечение времени храненияв кэше
    ...
    # Сохраняем все данные из буффера в файл
    def save(self):
        pickle.dump(
