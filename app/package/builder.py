...
# RCODE=2 (не реализовано), отстальные флаги = 0))
...
# Формируем запрос (в случае, если в кэше не было ответа и нужно обратиться к ДНС серверу)
...
# Собираем сообщение для ДНС сервера
def get_request(
