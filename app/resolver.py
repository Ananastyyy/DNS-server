...
def resolve(
    ...
    # в случае, если есть ответы на вопросы в принятом пакете, возвращаем полученное сообщение
    if response_package.header.an_count > 0:
        return response_package

    # если присутствуют авторитетные записи, то разрешаем каждые из этих имен в IP-адреса
